...
GTM_CONTAINER_ID = env.str('GTM_CONTAINER_ID', 'GTM-57X28ZF')
...
SENTRY_DSN = env.str('SENTRY_DSN', 'https://79fc9abeff8747c5851b6607e98da375@o361790.ingest.sentry.io/5197901')
SETTINGS_EXPORT = [
    'DOMAIN',
    'SITE_NAME',
    'WEBPACK_DEV_URL',
